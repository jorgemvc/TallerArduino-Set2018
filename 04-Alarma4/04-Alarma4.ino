...
const int   relayPin  = 12;    // Puero para el Relé
...
void setup() {
  ...
  pinMode(touchPin, INPUT);  // Establece el puerto como de entrada
  pinMode(relayPin, OUTPUT); // Establece el puerto como de salida
...
void loop() {
  ...
  digitalWrite(relayPin, accionada);
